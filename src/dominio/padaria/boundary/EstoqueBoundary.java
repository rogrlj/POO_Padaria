...
public class EstoqueBoundary implements ITelaStrategy{
	...
	public EstoqueBoundary() {
		...
		btnPesquisar.setOnAction((e) -> {control.pesquisarIngrediente();});
		btnAdicionar.setOnAction((e) -> {control.adicionar(); control.gerarHistorico("Adicionar");});
		btnRemover.setOnAction((e) -> {control.adicionar(); control.gerarHistorico("Remover");});
